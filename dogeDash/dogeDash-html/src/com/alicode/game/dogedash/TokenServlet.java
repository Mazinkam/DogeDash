...
public class TokenServlet extends HttpServlet {
	 ...
	 * 
	 * @param userId
	 *            The User whom the token is created for
	...
	public String createChannel(String userId) {
		try {
			...
			logger.log(Level.WARNING,
					"Unknown exception while creating channel");
			return null;
		}
	}
	 ...
	 * 
	 * @param response
	 *            The response object to write the response text
	 * @param token
	 *            The token which needs to be written in the response
	 * @throws IOException
	 */
