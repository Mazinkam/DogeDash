...
public class CustomizationScreen implements Screen {
	...
	private void processItem(int itemId) {
		if (menuState == MenuState.Buying) {
			...
			Gdx.app.log(Consts.LOG, "Menu state: " + menuState + " Doge state: " + state + " table: " + tableName + " image_shopCurrentItem " + image_shopCurrentItem.size
	...
	private void buyItem(int currentItemId) {
		...
		case Back:
			...
			Gdx.app.log(Consts.LOG, " currentItemId " + currentItemId);
			break;
		case Eyes:
	...
	@Override
	public void dispose() {
		Gdx.app.log(Consts.LOG, "back " + Statics.backCostume + " eyes: " + Statics.eyeCostume + " head: " + Statics.headCostume + " nose: " + Statics.noseCostume);
	}
